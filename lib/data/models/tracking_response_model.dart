...
class Result {
    ...
    factory Result.fromMap(Map<String, dynamic> json) => Result(
        ...
        manifest: json["manifest"] == null ? [] : List<Manifest>.from(json["manifest"]!.map((x) => Manifest.fromMap(x))),
        deliveryStatus: json["delivery_status"] == null ? null : DeliveryStatus.fromMap(json["delivery_status"]),
    );
    ...
    Map<String, dynamic> toMap() => {
        ...
        "manifest": manifest == null ? [] : List<dynamic>.from(manifest!.map((x) => x.toMap())),
...
class DeliveryStatus {
    ...
    factory DeliveryStatus.fromJson(String str) => DeliveryStatus.fromMap(json.decode(str));
    ...
    factory DeliveryStatus.fromMap(Map<String, dynamic> json) => DeliveryStatus(
        ...
        podDate: json["pod_date"] == null ? null : DateTime.parse(json["pod_date"]),
    ...
    Map<String, dynamic> toMap() => {
        ...
        "pod_date": "${podDate!.year.toString().padLeft(4, '0')}-${podDate!.month.toString().padLeft(2, '0')}-${podDate!.day.toString().padLeft(2, '0')}",
        "pod_time": podTime,
    };
}
...
class Details {
    ...
    factory Details.fromMap(Map<String, dynamic> json) => Details(
        ...
        waybillDate: json["waybill_date"] == null ? null : DateTime.parse(json["waybill_date"]),
...
class Manifest {
    ...
    factory Manifest.fromMap(Map<String, dynamic> json) => Manifest(
        ...
        manifestDate: json["manifest_date"] == null ? null : DateTime.parse(json["manifest_date"]),
